            ...
            <div className="relative px-4 pt-6 ">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col justify-center items-center">
                  <h2 className="text-center -mb-5 font-black">{totalHours}:{totalMinutes} Total </h2>
                            ...
                            {flight.path.slice(0, -1).map((airport, j) => {
                              ...
                              return (
                                <div className="flex flex-col space-around w-full mb-2">
                                  ...
                                  <div className={`flex flex-row w-full justify-between border-2 ${i > 0 ? "border-slate-300" : "border-yellow-300"} rounded-lg`}>
